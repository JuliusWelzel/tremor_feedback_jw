function [ tfSpec, windowVec, freqVec ] = myTF( data, srate, winLength,overlap,topplot,varargin )
...
ylim([0,srate/8]);          % cut of the frequencies to only show frequencies which are 8 times oversampled.    
...
title (['TF plot for window of type: ' whichWin]);
