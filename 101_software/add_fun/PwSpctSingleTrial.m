function [ spec_vec freq_vec ]= PwSpectSingleTrial(ts_trial,time_vec,srate)
%PwSpectSingleTrial: Get spectrum output plot form single trial data using
%MatLabs FFT implementation 
%
%Input:
